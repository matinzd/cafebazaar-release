...
exports.api = axios_1.default.create({ baseURL: constants_1.baseUrl });
...
const createPackage = (file_path, architecture = types_1.Architecture.all) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (files.length > 0) {
        ...
        for (const file of files) {
            ...
            const headers = Object.assign({ Accept: "application/json" }, data.getHeaders());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HEADER_AUTHORIZATION_KEY = exports.lastUncommitted = exports.commit = exports.upload = exports.releases = exports.baseUrl = void 0;
exports.baseUrl = "https://api.pishkhan.cafebazaar.ir/v1";
...
const core = __importStar(__nccwpck_require__(2186));
const api_1 = __nccwpck_require__(8947);
const cafebazaar_1 = __nccwpck_require__(3410);
const constants_1 = __nccwpck_require__(5105);
function run() {
...
(function (Architecture) {
    Architecture[Architecture["all"] = 0] = "all";
    Architecture[Architecture["armeabi-v7a"] = 1] = "armeabi-v7a";
    Architecture[Architecture["arm64-v8a"] = 2] = "arm64-v8a";
